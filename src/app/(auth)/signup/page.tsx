export default function SignupPage() {
  return (
    <div className="flex h-[600px] w-full max-w-2xl bg-white rounded-xl overflow-hidden border border-gray-200 shadow-sm">
      {/* Left visual */}
      <div className="w-1/2 bg-gradient-to-br from-blue-500 to-blue-700 flex flex-col items-center justify-center text-white p-8">
